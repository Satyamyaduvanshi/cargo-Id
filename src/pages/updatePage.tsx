          ...
          <div className="space-y-4 md:space-y-5">
            {allProducts.length > 0 ? (
              <div className="relative">
                <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-primary">
                  <Package size={16} className="flex-shrink-0 mr-2" />
                </div>
                <select
                  value={productName}
                  onChange={(e) => setProductName(e.target.value)}
                  className="pl-14 w-full p-2.5 md:p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all appearance-none bg-white text-sm md:text-base"
                >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-14 w-full p-2.5 md:p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all text-sm md:text-base"
              />
            </div>

            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-primary">
                <MapPin size={16} className="flex-shrink-0 mr-2" />
              </div>
              <input
                type="text"
